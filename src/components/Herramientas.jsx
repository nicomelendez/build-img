  ...
  return (
    <div className="flex flex-col lg:flex-row  w-full gap-4 justify-around">
        <div className="mx-auto w-full flex flex-row flex-wrap lg:space-y-4 lg:flex-col justify-evenly pb-3">
            ...
            return(
                    <div className="bg-slate-100 text-gray-900 w-12 h-12 text-[10px] lg:w-14 lg:h-14 lg:text-xs flex flex-col items-center justify-center hover:cursor-pointer rounded-full sombra" onClick={()=>{handlerEfecto(her)}} key={her.id}>
                        <div className="">
                            <span>{her.icons}</span>
                        </div>
                        <div>
